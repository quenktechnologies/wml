...
var main = function (cwd, args) { return (0, future_1.doFuture)(function () {
    var path, opts, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                path = (0, path_1.resolve)(cwd, args['<path>']);
                opts = (0, record_1.merge)(defaultOptions, getOptions(args));
                return [4 /*yield*/, (0, file_1.isDirectory)(path)];
            case 1:
                result = _a.sent();
