...
var attrsEscRegex = new RegExp("[".concat((0, record_1.mapTo)(ATTR_ESC_MAP, function (_, k) { return k; }), "]"), 'g');
var HTML_ENT_MAP = {
    '"': '&quot;',
    '&': '&amp;',
    '\'': '&apos;',
...
var htmlEscRegex = new RegExp("[".concat((0, record_1.mapTo)(HTML_ENT_MAP, function (_, k) { return k; }), "]"), 'g');
var voidElements = [
    'area',
    'base',
    'br',
...
var WMLDOMElement = /** @class */ (function (_super) {
    ...
    Object.defineProperty(WMLDOMElement.prototype, "outerHTML", {
        get: function () {
            ...
            var attrs = (0, record_1.mapTo)((0, exports.escapeAttrs)(this.attrs), function (value, name) { return !value ?
                name : "".concat(name, "=\"").concat(value, "\""); }).join(' ');
            attrs = (attrs.trim() != '') ? " ".concat(attrs) : '';
            var open = "<".concat(tag).concat(attrs, ">");
            if (tag === "html")
 ...
 */
var escapeAttrs = function (attrs) { return (0, record_1.map)(attrs, function (value) {
    return (0, type_1.isFunction)(value) ? value :
 ...
 */
var createUnsafeNode = function (txt) {
    var str = String((txt == null) ? '' : txt);
...
var createBrowserUnsafeNode = function (html) {
...
var createElement = function (tag, attrs, children) {
    ...
    if (!exports.isBrowser) {
        ...
        (0, record_1.forEach)(attrs, function (value, key) {
