...
exports.tests = {
    ...
    '[context] should parse generic constructors': '{% context Test table.name: Text[A] %}',
    '[context] should parse record types': "{% context Test[A]\n         \n        table.data.record: { \n\n          name: String \n          table.name: Text[A] \n          table.data.list: A[] \n          } \n        %}",
    '[context] should parse list types': "{% context Test[A] table.data.list: A[] %}",
    '[context] should parse 2d list types': "{% context Test[A,B] table.data.list2: A[][] %}",
    '[context] should parse 3d list types': "{% context Test[A, B, C] table.data.list3: A[][][] %}",
    '[context] should parse func with no args or parens': "{% context Test value: Test => Number %}",
    '[context] should parse func with no args': "{% context Test value: () => Number %}",
    '[context] should parse no-parens func with constructor': "{% context Test value: String => String %}",
    '[context] should parse no-parens func with generic constructor': "{% context Test value: Text[A] => Text[A] %}",
    '[context] should parse no-parens func with record arg': "{% context Test value: {} => { } %}",
    '[context] should parse no-parens func with list arg': "{% context Test value: String[] => String[] %}",
    '[context] should parse func with cons arg': "{% context Test value: (String) => String %}",
    '[context] should parse func with 2 cons args': "{% context Test value: (String, String) => String %}",
    '[context] should parse func with 3 cons args': "{% context Test value: (String, String, String) => String %}",
    '[context] should parse func with generic cons arg': "{% context Test[A] value: (Text[A]) => Text[A] %}",
    '[context] should parse func with 2 generic cons args': "{% context Test[A] value: (Text[A], Text[A]) => Text[A] %}",
    '[context] should parse func with 3 generic cons args': "{% context Test[A] value: (Text[A], Text[A], Text[A]) => Text[A] %}",
    '[context] should parse func with record arg': "{% context Test value: ({ }) => { } %}",
    '[context] should parse func with 2 record args': "{% context Test value: ({ }, { name: String }) => { } %}",
    '[context] should parse func with 3 record args': "{% context Test value: ({ }, { name: String }, { value: A[]}) => { } %}",
    '[context] should parse func with list arg': "{% context Test value: (String[]) => String[] %}",
    '[context] should parse func with 2 list args': "{% context Test value: (String[], String[]) => String[] %}",
    '[context] should parse func with 3 list args': "{% context Test value: (String[], String[], String[]) => String[] %}",
    '[context] should parse func with func arg': "{% context Test value: (String => String) => String %}",
    '[context] should parse func with 2 func args': "{% context Test value: ((String => String), (String => String)) => String %}",
    '[context] should parse func with 3 func args': "{% context Test \n          value: ((String => String), (String => String), (String => String)) => String \n         %}",
    '[context] should parse func that return array of generic type': "{% context Test[A] value: Number => Text[A][] %}",
    '[context] should parse funct that return array of array': "{% context Test value: String => Number[][] %}",
