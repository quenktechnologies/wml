...
var ContractStatement = /** @class */ (function () {
    function ContractStatement(id, typeParameters, members, location) {
        this.id = id;
        this.typeParameters = typeParameters;
        this.members = members;
        this.location = location;
...
var MemberDeclaration = /** @class */ (function () {
    function MemberDeclaration(path, kind, location) {
        this.path = path;
        this.kind = kind;
        this.location = location;
