...
class ForStatement {
    constructor(body, otherwise, location) {
        this.body = body;
...
class ForInStatement extends ForStatement {
...
class ForOfStatement extends ForStatement {
    constructor(variables, expression, body, otherwise, location) {
        super(body, otherwise, location);
        this.variables = variables;
        this.expression = expression;
...
class ForFromStatement extends ForStatement {
