 ...
 * ContractStatement
 */
var ContractStatement = /** @class */ (function () {
    function ContractStatement(id, typeParameters, parents, members, location) {
        this.id = id;
        this.typeParameters = typeParameters;
...
exports.ContractStatement = ContractStatement;
/**
 * MemberDeclaration
 */
 ...
 * InstanceStatement
 */
var InstanceStatement = /** @class */ (function () {
    function InstanceStatement(id, cons, properties, location) {
        this.id = id;
        this.cons = cons;
        this.properties = properties;
        this.location = location;
        this.type = 'instance-statement';
    }
    return InstanceStatement;
}());
exports.InstanceStatement = InstanceStatement;
/**
 * ViewStatement
 */
var ViewStatement = /** @class */ (function () {
    function ViewStatement(id, typeParameters, context, instances, root, location) {
        this.id = id;
        this.typeParameters = typeParameters;
