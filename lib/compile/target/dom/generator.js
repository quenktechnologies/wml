...
var NODE_PARAMS = "tag:string, attrs:" + output_1.WML + ".Attrs, " +
    ("children: " + output_1.WML + ".Content[]");
var WIDGET_PARAMS = "w: " + output_1.WML + ".Widget, attrs:" + output_1.WML + ".Attrs";
var REGISTER_VIEW_PARAMS = "v:" + output_1.WML + ".View";
...
var DOMGenerator = /** @class */ (function () {
    ...
    DOMGenerator.prototype.view = function (ctx, n) {
        ...
        var typeParams = output_1.typeParameters2TS(n.typeParameters);
        ...
        return [
            ...
            "",
            "   registerView(" + REGISTER_VIEW_PARAMS + ") : " + output_1.WML + ".View {",
            "",
            "       this.views.push(v);",
            "",
            "       return v;",
            ...
            "",
            "       let attrsMap = (<" + output_1.WML + ".Attrs><any>attrs)",
            "",
            "       if(attrsMap.wml) {",
            "",
    ...
    DOMGenerator.prototype.fun = function (ctx, n) {
        ...
        var params = (n.parameters.length === 0) ? '' :
            n.parameters.map(output_1.parameter2TS).join(',');
    ...
    DOMGenerator.prototype.widget = function (ctx, w) {
        ...
        return output_1.THIS + ".widget(new " + name + "(" + attrs + ", " + childs + ")," +
            ("<" + output_1.WML + ".Attrs>" + attrs + ")");
    };
    DOMGenerator.prototype.node = function (ctx, n) {
        ...
        return output_1.THIS + ".node('" + name + "', <" + output_1.WML + ".Attrs>" + attrs + ", " + childs + ")";
    };
